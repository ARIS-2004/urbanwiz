...
export default function ContactHero() {
  ...
  // Subtle mouse parallax on the right image
  const px = useSpring(useTransform(mx, [-1, 1], [-12, 12]), {
    stiffness: 80,
    damping: 20,
  });
  const py = useSpring(useTransform(my, [-1, 1], [-8, 8]), {
    stiffness: 80,
    damping: 20,
  });

  // Scroll-tied subtle drift on the image
    ...
    >
      ...
      <div className="container-wide relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-6 lg:max-w-[560px]">
            ...
            >
              ...
              <div className="text-[12px] text-navy/55 leading-snug">
                ...
                standing by — senior owner on every account.
              </div>
            </motion.div>
          ...
          {/* Right — static mockup, bumped up + larger */}
          <div className="lg:col-span-6 xl:col-span-6 self-start relative lg:-mt-8">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4, duration: 1.1, ease }}
              className="relative w-full aspect-[5/4] lg:aspect-[5/4] max-w-[760px] mx-auto"
            >
              <Image
                src="/contacthero.png"
                alt="UrbanWizz support dashboard"
                fill
                priority
